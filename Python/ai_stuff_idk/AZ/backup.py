...
class ResNet(nn.Module):
    def __init__(self, game, num_resBlocks, num_hidden, device):
        ...
        self.valueHead = nn.Sequential(
            nn.Conv2d(in_channels= num_hidden, out_channels= 2, kernel_size = 3, padding= 1),
            nn.BatchNorm2d(2),
            nn.ReLU(),
            nn.Flatten(),
...
class AlphaZero:
    ...
    def selfPlay(self):
        ...
        while True:
            ...
            action_probs = self.mcts.search(neutral_state, prev_action= action)
    ...
    def train(self, memory):
        ...
        for batchIdx in range(0, len(memory), self.args['batch_size']):
            ...
            predicted_policy_logsoftmax = F.log_softmax(predicted_policy, dim=1)
